...
- **Resumen del grupo**: al finalizar el rosco completo, se muestra un modal con todas las respuestas correctas e incorrectas (letra, respuesta y pregunta). Desde ahí se puede continuar con los otros grupos, ir a los resultados finales, o reiniciar el juego.
